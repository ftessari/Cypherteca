 ...
 * UsuariosMailFixture
 */
class UsuariosMailFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'usuarios_mail_ibfk_1' => ['type' => 'foreign', 'columns' => ['de'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'usuarios_mail_ibfk_2' => ['type' => 'foreign', 'columns' => ['para'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'usuarios_mail_ibfk_3' => ['type' => 'foreign', 'columns' => ['cc'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_envio' => '2019-08-13 16:22:25',
                'data_lido' => '2019-08-13 16:22:25',
                'cc' => 1
            ],
        ];
        parent::init();
