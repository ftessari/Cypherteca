 ...
 * UstatusFixture
 */
class UstatusFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ustatus_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_status'], 'references' => ['status', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ustatus_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_user'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
